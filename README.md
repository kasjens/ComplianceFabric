...
Phase 4's data-and-logic scope is now complete; what remains is operational hardening (incremental screening of streamed responses and a reference deployment) rather than new control logic. See [`ROADMAP.md`](ROADMAP.md) for detail, [`CHANGELOG.md`](CHANGELOG.md) for recent changes, and [`CONTRIBUTING.md`](CONTRIBUTING.md) if you want to help build it.
